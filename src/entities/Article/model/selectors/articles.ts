...
export const getArticlesView = (state: StateSchema) => state.articlesPage?.view || 'grid';
...
export const getArticlesSort = (state: StateSchema) => state.articlesPage?.sort ?? EArticleSortField.CREATED;
export const getArticlesSearch = (state: StateSchema) => state.articlesPage?.search ?? '';
export const getArticlesType = (state: StateSchema) => state.articlesPage?.type ?? EArticleType.ALL;
