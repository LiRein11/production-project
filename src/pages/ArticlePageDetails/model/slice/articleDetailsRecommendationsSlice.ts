...
export const getArticleRecommendations = recommendationsAdapter.getSelectors<StateSchema>((state) => state.articlePageDetails?.recommendations || recommendationsAdapter.getInitialState());
