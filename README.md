...
используется собственный eslint plugin _eslint-plugin-sergey-plugin_,
...
-   [onEditBtn](/src/features/onEditBtn)
...
-   [LoaderPage](/src/widgets/LoaderPage)
...
-   [ArticlePageDetails](/src/pages/ArticlePageDetails)
